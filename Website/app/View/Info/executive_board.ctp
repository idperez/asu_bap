...
<div id="fh5co-work-section">
                ...
                <div class="row">
                    <div class="col-lg-offset-3"> 
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <span><h3 class="heading-section">Hunter Moisson<br><br><p>President</p></h3></span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <span><h3 class="heading-section">Jordan Yovanovich<br><br><p>Vice President</p></h3></span>
    ...
    <div class="container animate-box">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">               
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <span><h3 class="heading-section">Kaitlin Culver<br><br><p style="font-size: 15px;">Director of External Operations</p></h3></span>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <span><h3 class="heading-section">Allison McClelland<br><br><p style="font-size: 15px;">Director of Internal Communications</p></h3></span>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <span><h3 class="heading-section">George Kemper<br><br><p style="font-size: 15px;">Director of Recruiting</p></h3></span>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">  
                <div class="row">
                    <div class="col-lg-offset-3"> 
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <span><h3 class="heading-section">Zachary Sorel<br><br><p>Treasurer</p></h3></span>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <span><h3 class="heading-section">Michael Garverick<br><br><p>Faculty Advisor</p></h3></span>
