    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 animate-box">
                <h3 class="heading-section">Get in the know</h3>
                <p>Check out all of what it takes to be the best member you can be</p>
            </div>
            ...
            <div class="col-md-offset-3 col-sm-offset-3 col-md-9 col-sm-12">
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="services animate-box">                          
