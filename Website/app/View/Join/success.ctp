<div class="fh5co-hero">
    ...
    <div class="fh5co-cover text-center" style="background-image: url(./../app/webroot/img/success.jpg); ">
        <div class="desc animate-box" style="position:relative; top:260px; ">
            <div class="text-center"><h2>Success!</h2></div>
            <h3 style="font-style: italic; color: white;">Thank you for registering. We will email you soon.</h3>  
            <br>
            <span ><a class="btn btn-primary" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Info', 'action'=>'index'))?>'" style="position:relative; top:-20px;">Explore</a></span>
