    ...
    <div class="container">    
        <div class="row animate-box">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3" >
                ...
                <div class="fh5co-blog" style="background-image: url(/bap/Website/app/webroot/img/profile_pics/Perez,Isidro.jpg); height: 250px; width: 240px;"></div>
                <span ><a class="btn btn-primary" style="margin-bottom: 5px; width: 200px" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Users', 'action'=>'edit/'.$user['User']['id']))?>'">Edit Info</a></span>
                <span ><a class="btn btn-primary" style="margin-bottom: 5px; width: 200px" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Users', 'action'=>'logout'))?>'">Logout</a></span>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
                <div style="margin-bottom: 20px">
                    ...
                    <span ><a class="btn btn-primary" style="margin-bottom: 5px; width: 200px" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Users', 'action'=>'my_events/'.$user['User']['id']))?>'">Events Attended</a></span>
                ...
                <div>
                    <h2>Officer Tools</h2>
                    <span ><a class="btn btn-primary" style="margin-bottom: 5px; width: 200px" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Users', 'action'=>'edit/'.$user['User']['id']))?>'">Manage Events</a></span>
                    <span ><a class="btn btn-primary" style="margin-bottom: 5px; width: 200px" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Users', 'action'=>'edit/'.$user['User']['id']))?>'">Manage Members</a></span>
                </div>
            </div>
